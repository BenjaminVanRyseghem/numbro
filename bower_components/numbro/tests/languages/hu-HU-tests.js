...
const huHU = require("../../languages/hu-HU");

describe("hu-HU", () => {
    beforeAll(() => {
        numbro.registerLanguage(huHU, true);
    });
    ...
    it("formats currency correctly", () => {
        let data = [
            [1000.234, "$", "1,000 EFt"],
            [1000.234, "0,0.00$", "1 000,23Ft"],
            [-1000.234, "(0,0$)", "(1 000,234)Ft"],
            [-1000.234, "0.00$", "-1000,23Ft"],
            [1230974, "(0.00a$)", "1,23MFt"]
        ];
