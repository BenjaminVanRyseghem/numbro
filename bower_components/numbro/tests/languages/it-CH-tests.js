...
const itCH = require("../../languages/it-CH");

describe("it-CH", () => {
    beforeAll(() => {
        numbro.registerLanguage(itCH, true);
    });
    ...
    it("formats currency correctly", () => {
        let data = [
            [1000.234, "$0,0.00", "1'000.23CHF"],
            [-1000.234, "($0,0)", "(1'000.234)CHF"],
            [-1000.234, "$0.00", "-1000.23CHF"],
            [1230974, "($0.00a)", "1.23milCHF"]
        ];
