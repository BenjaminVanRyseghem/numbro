...
const srCyrlRS = require("../../languages/sr-Cyrl-RS");

describe("sr-Cyrl-RS", () => {
    beforeAll(() => {
        numbro.registerLanguage(srCyrlRS, true);
    });
    ...
    it("formats currency correctly", () => {
        let data = [
            [1000.234, "$0,0.00", "1.000,23RSD"],
            [-1000.234, "($0,0)", "(1.000,234)RSD"],
            [-1000.234, "$0.00", "-1000,23RSD"],
            [1230974, "($0.00a)", "1,23млнRSD"]
        ];
