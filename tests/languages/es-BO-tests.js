...
const esBO = require("../../languages/es-BO");

describe("es-BO", () => {
    beforeAll(() => {
        numbro.registerLanguage(esBO, true);
    });
    ...
    it("formats currency correctly", () => {
        let data = [
            [1000.234, "$", "Bs 1.000 k"],
            [1000.234, "$0,0.00", "Bs1,000.23"],
            [-1000.234, "($0,0)", "Bs(1,000.234)"],
            [-1000.234, "$0.00", "-Bs1000.23"],
            [1230974, "($0.00a)", "Bs1.23mm"]
        ];
