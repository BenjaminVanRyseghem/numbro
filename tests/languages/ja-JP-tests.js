...
const jaJP = require("../../languages/ja-JP");
const enableCjkForLanguage = require("../helpers/enableCjkForLanguage");

describe("ja-JP", () => {
    beforeAll(() => {
        enableCjkForLanguage(jaJP);
        numbro.registerLanguage(jaJP, true);
    });
    ...
    it("formats currency correctly", () => {
        let data = [
            [1000.234, "$0,0.00", "1,000.23円"],
            [-1000.234, "($0,0)", "(1,000.234)円"],
            [-1000.234, "$0.00", "-1000.23円"],
            [1230974, "($0.00a)", "123.10万円"]
        ];
